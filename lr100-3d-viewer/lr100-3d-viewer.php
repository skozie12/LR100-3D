...
function lr100_enqueue_3d_assets() {
  // reference the actual files from the build output
  wp_enqueue_script(
    'lr100-3d-app',
  ...
  // Enqueue the physics worker script if needed
  wp_enqueue_script(
    'lr100-3d-physics-worker',
    plugins_url('dist/assets/physicsWorker-iiFlsN1r.js', __FILE__),
    [],
    null,
    true
  );
